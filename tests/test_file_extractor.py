...
def test_extract_text_from_file_auto_detection():
    ...
    with patch('canvas_mcp.utils.file_extractor.extract_text_from_docx_url') as mock_docx:
...
def test_url_content_extraction():
    ...
    with patch('canvas_mcp.utils.file_extractor.requests.get') as mock_get, \
         patch('canvas_mcp.utils.file_extractor.extract_text_from_pdf_file') as mock_pdf_extract, \
