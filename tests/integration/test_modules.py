...
from canvas_mcp.tools.modules import get_course_modules


def test_get_course_modules(test_context, target_course_info):
    ...
    modules = get_course_modules(
        test_context, target_course_info["internal_id"], include_items=False
    )
    ...
    modules_with_items = get_course_modules(
        test_context, target_course_info["internal_id"], include_items=True
    )
