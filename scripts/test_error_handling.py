...
class MockCanvas:
    ...
    def __init__(self, exception_type=Exception, exception_message="Simulated API error"):
...
class MockDatabaseManager:
    ...
    def __init__(self, exception_type=Exception, exception_message="Simulated database error"):
        self.exception_type = exception_type
        self.exception_message = exception_message
